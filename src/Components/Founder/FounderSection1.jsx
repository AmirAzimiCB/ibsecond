    ...
    <div className='founder-section1-container founder-section'>
      ...
      <div className='founder-section1-text-container founder-text-container '>
        <span className='founder-text-bg founder1-text'>
          ...
          of a single-mother household in inner-city Philadelphia, from an early
          age, Talia grew up, in-and-among various subcultures. It is through
          this lens that Talia developed a passion for journalistic storytelling
          as a means of shining a light on those whose narratives have been
          overlooked or erased. Talia began writing poetry and novels, based on,
          and inspired by her surroundings, as well as crafting visual art
          pieces, that told stories of her own community.{" "}
        </span>
      </div>
    </div>
  );
